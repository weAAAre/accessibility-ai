  ...
  return [
    ...
    },
    {
      ...
      description: [
        ...
        "- toggleSingleKeyQuickNav: Enable single-key Quick Nav. Then press 'h' to jump to next heading, Shift+h for previous, 'l' for links, etc.",
        ...
        '- rotor: Open the VoiceOver rotor for structured navigation.',
