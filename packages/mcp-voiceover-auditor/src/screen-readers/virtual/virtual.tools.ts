  ...
  return [
    ...
    },
    {
      ...
      description: [
        ...
        '',
        'VoiceOver-compatible commands: findNextHeading, findPreviousHeading, findNextLink, findPreviousLink, findNextControl, findPreviousControl.',
        '',
...
function buildHandlers(adapter: VirtualScreenReaderAdapter): Map<string, ToolHandler> {
...
export function createVirtualTools(adapter: VirtualScreenReaderAdapter): ToolModule {
  return {
    tools: defineTools(),
