...
// No macOS, no VoiceOver, no AppleScript — works on any OS.
...
const virtualFullAudit: PromptDefinition = {
  prompt: {
    ...
    description:
      'Comprehensive virtual screen reader audit. Covers headings, landmarks, links, forms, images, and keyboard navigation. No macOS or VoiceOver required.',
    arguments: [
      {
        name: 'url',
        description: 'URL of the page to audit',
